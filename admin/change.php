            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form method="post" action="class/changeControler.php" class="user">
                    <div class="form-group">
                      <input type="password" name="npassword" class="form-control form-control-user" id="exampleInputEmail"  placeholder="New Password">
                    </div>
                    <div class="form-group">
                      <input type="password" name="cpassword" class="form-control form-control-user" id="exampleInputPassword" placeholder="Confirm Password">
                    </div>
