...
<center>
	...
	<?php endforeach; endif; ?>
	    ...
	    <select id="display" class="col-md-3">
			...
			<input type="hidden" name="" id="type" value="For Rent">
...
<a href="categories.php"><div class="rent-notic">All</div></a>
...
<div class="row">
<?php
if(!isset($_GET['range'])): $query= $db->getRows('houses', array('orderd by' => 'id asc', 'where'=>array('category'=>'For Rent','status'=>0)));
elseif(isset($_GET['range'])):
	if($_GET['range']==1):
		$query= $db->getRows('houses', array('order_by' => 'id asc', 'start'=>0, 'limit'=>12, 'where'=>array('category'=>'For Rent','status'=>0)));
	elseif($_GET['range']==2):
		$query= $db->getRows('houses', array('order_by' => 'id asc', 'start'=>13, 'limit'=>12, 'where'=>array('category'=>'For Rent','status'=>0)));
	elseif($_GET['range']==3):
		$query= $db->getRows('houses', array('order_by' => 'id asc', 'start'=>25, 'limit'=>12, 'where'=>array('category'=>'For Rent','status'=>0)));
	elseif($_GET['range']==4):
		$query= $db->getRows('houses', array('order_by' => 'id asc', 'start'=>37, 'limit'=>12, 'where'=>array('category'=>'For Rent','status'=>0)));
	endif;
endif;
...
<a href="categories-for-rent.php?range=1">1</a>
<?php endif; if($count>=13 and $count<=24): ?>
<a href="categories-for-rent.php?range=2">2</a>
<?php endif; if($count>=25 and $count<=36): ?>
<a href="categories-for-rent.php?range=3">3</a>
<?php endif; if($count>=37 and $count<=48): ?>
<a href="categories-for-rent.php?range">4</a>
<?php endif; ?>
</div>
</div>
</section>
